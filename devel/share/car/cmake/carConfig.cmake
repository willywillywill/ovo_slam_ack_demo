...
if("TRUE" STREQUAL "TRUE")
  set(car_SOURCE_PREFIX /ros_ws/src/car)
  set(car_DEVEL_PREFIX /ros_ws/devel)
  set(car_INSTALL_PREFIX "")
  set(car_PREFIX ${car_DEVEL_PREFIX})
else()
  set(car_SOURCE_PREFIX "")
  set(car_DEVEL_PREFIX "")
  set(car_INSTALL_PREFIX /ros_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'car' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/ros_ws/src/car/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT car_NUM_DUMMY_TARGETS)
      set(car_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::car::wrapped-linker-option${car_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR car_NUM_DUMMY_TARGETS "${car_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::car::wrapped-linker-option${car_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND car_LIBRARIES "${interface_target_name}")
  elseif(${library} MATCHES "^\\$<")
    list(APPEND car_LIBRARIES ${library})
...
foreach(depend ${depends})
  ...
  _list_append_deduplicate(car_EXPORTED_TARGETS ${${car_dep}_EXPORTED_TARGETS})
endforeach()
